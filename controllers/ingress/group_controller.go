...
func NewGroupReconciler(cloud services.Cloud, k8sClient client.Client, eventRecorder record.EventRecorder,
	...
	modelBuilder := ingress.NewDefaultModelBuilder(k8sClient, eventRecorder,
		...
		controllerConfig.EnableBackendSecurityGroup, controllerConfig.EnableManagedBackendSGRules, controllerConfig.DisableRestrictedSGRules, controllerConfig.IngressConfig.AllowedCertificateAuthorityARNs, controllerConfig.FeatureGates.Enabled(config.EnableIPTargetType), logger)
